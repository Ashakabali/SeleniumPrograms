...
@Test 
public void b_registration() throws InterruptedException {
		//Registration
		driver.findElement(By.xpath("//a[@class='login']")).click();
		driver.findElement(By.id("email_create")).sendKeys("July22th@yopmail.com");
		Thread.sleep(2000);
...
public void f_signin() {
		//Sign in
		driver.findElement(By.id("email")).sendKeys("July22th@yopmail.com");
		driver.findElement(By.id("passwd")).sendKeys("Passw0rd$123");
